...
//##########
if(is_dir(_BASE_PATH_INCLUDE.'VDCS.res/')) $path_res=_BASE_PATH_INCLUDE.'VDCS.res/';
else{
	//debugx(VDCS_PATH);
	$path_res=VDCS_PATH;
	$path_res=substr($path_res,0,strrpos($path_res,'/'));
	$path_res=substr($path_res,0,strrpos($path_res,'/')+1).'VDCS.res/';
	//debugx($path_res);
	//'/home/VSAP/VDCS.res/'
	//'D:/VSAP/VDCS.res/'
...
$_cfg['sys.dir']['vdcs.module']			= VDCS_MODULE_PATH;
$_cfg['sys.dir']['vdcs.web']			= VDCS_WEB_PATH;
$_cfg['sys.dir']['vdcs.web.config']		= VDCS_WEB_CONFIG_PATH;
