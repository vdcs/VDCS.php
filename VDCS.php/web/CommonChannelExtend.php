	...
	*/
	...
	private static function loadStruct()
	{
		if(!isTable(self::$tableChannelStruct)){
			...
			//##########
			$aryTypeName[1]='article';		//commons.DeCrypt123('865878627279707')
			$aryTypeName[11]='news';		//commons.DeCrypt123('970748488')
			$aryTypeName[3]='photo';		//commons.DeCrypt123('58774084898')
			$aryTypeName[10]='shop,ask,blog';	//commons.DeCrypt123('584718284176537381786814778')
			//##########
