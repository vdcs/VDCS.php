<?
class ChannelClubMuBase extends WebPortalBase
{
	...
	{
		parent::__destruct();
		unset($this->treeBase,$this->treeBlog,$this->tableBlogSort);
		unset($this->treeUser);
	}
	...
	*/
	public function initBasic()
	{
		...
		$this->chnBlog=$cfg->getChannelStruct('blog');
