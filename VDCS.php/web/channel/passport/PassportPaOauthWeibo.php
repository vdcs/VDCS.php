<?
class PassportPaOauthWeibo extends ChannelPaBase
{
	use PassportOauthRef,PassportOauthRefPa;
	protected $AUTHRC='weibo';
	...
	public function doParseAuthorize()
	{
	...
	public function doParseCallback()
	{
		...
		if(!$this->oa->isBind()){
			if(!$this->oa->isData()){
				...
				//debugTree($this->oa->results);
				$this->oa->setVar('openid',$this->oa->results->getItem('uid'));
