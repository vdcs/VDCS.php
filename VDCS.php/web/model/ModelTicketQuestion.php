...
class TicketQuestion{
	const TableName			= 'db_ticket_question';
	const TablePX			= '';
	const FieldID			= 'q_id';
	const TableFields		='uuid,uurc,sortid,idcid,type,pid,q_content,q_topic,q_supply,q_priority,q_process,q_status,q_tim,q_explain';
	...
	public static function addData($ua,&$tData)
	{
		...
		$tData->addItem('q_status',1);
		$tData->addItem('q_tim',DCS::timer());
